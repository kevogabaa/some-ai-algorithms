...
The A* algorithm is a best-first search algorithm in which the cost associated with a node is f(n)
...
The A* algorithm introduces a heuristic into a regular graph-searching algorithm, essentially
planning ahead at each step so a more optimal decision is made. For this reason, A* is known as an
algorithm with brains.
